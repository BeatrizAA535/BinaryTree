...
public:
	...
	void PrintLNR(Node* ptr);
	void PrintNLR(Node* ptr);
	void PrintLRN(Node* ptr);
	void FillAdjacencyMatrix(Node* ptr, int adj[50][50]);
	void PrintAdjacencyMatrix(int adj[50][50]);
};